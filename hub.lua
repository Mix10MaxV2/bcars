...
local function QQFHXR_fake_script() -- TextButton.LocalScript 
...
coroutine.wrap(QQFHXR_fake_script)()
local function ZIKC_fake_script() -- TextButton_2.LocalScript 
...
coroutine.wrap(ZIKC_fake_script)()
local function XMGQFH_fake_script() -- MainFrame.DraggableScript 
...
coroutine.wrap(XMGQFH_fake_script)()
local function UQPUUN_fake_script() -- TextButton_3.LocalScript 
...
coroutine.wrap(UQPUUN_fake_script)()
local function ARIVOLT_fake_script() -- Button.iy 
...
coroutine.wrap(ARIVOLT_fake_script)()
local function AODZ_fake_script() -- Button_2.cc2 
...
coroutine.wrap(AODZ_fake_script)()
local function JUTK_fake_script() -- TextButton_4.LocalScript 
...
coroutine.wrap(JUTK_fake_script)()
local function QWCLX_fake_script() -- TextButton_5.LocalScript 
...
coroutine.wrap(QWCLX_fake_script)()
local function RGLHUKJ_fake_script() -- Button_3.jp 
...
coroutine.wrap(RGLHUKJ_fake_script)()
local function FIFV_fake_script() -- Button_4.LocalScript 
...
coroutine.wrap(FIFV_fake_script)()
local function YNKGV_fake_script() -- Button_5.jp 
...
coroutine.wrap(YNKGV_fake_script)()
local function VSBNF_fake_script() -- Button_6.jp 
...
coroutine.wrap(VSBNF_fake_script)()
local function WSYEL_fake_script() -- Button_7.jp 
...
coroutine.wrap(WSYEL_fake_script)()
local function CHSY_fake_script() -- Button_8.jp 
...
coroutine.wrap(CHSY_fake_script)()
local function IFLW_fake_script() -- LoginFrame.DraggableScript 
...
coroutine.wrap(IFLW_fake_script)()
local function TGTT_fake_script() -- Button_9.LocalScript 
	...
	script.Parent.MouseButton1Click:Connect(function()
		if script.Parent.Parent.Password.Text == "Caprisun7" and script.Parent.Parent.TextBox.Text == "kirbss" then	
			script.Parent.Parent.Status.Text = "User & Password Match"
			wait(1)
			script.Parent.Parent.Status.Text = "Connecting to database"
			wait(0.6)
...
coroutine.wrap(TGTT_fake_script)()
local function DAZBQ_fake_script() -- TextButton_7.LocalScript 
...
coroutine.wrap(DAZBQ_fake_script)()
